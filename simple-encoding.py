...
class Encoder:
    def __init__(self, destination, preset, pipeline, duration):
      self.formats = {
...
def addJob(preset):
  pipeline, duration = shortPipeLine()
  renderJobs.append(Encoder(outputFile, preset, pipeline, duration))
